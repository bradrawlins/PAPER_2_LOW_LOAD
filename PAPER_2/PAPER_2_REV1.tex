...
\nomenclature[B]{$\epsilon$}{Emissivity \nomunit{$-$}}
...
\begin{figure}[h!]
	\subfigure[100 \% MCR]{\includegraphics[width=0.32\textwidth]{100_VALID_BAR}}
	\subfigure[80 \% MCR]{\includegraphics[width=0.32\textwidth]{80_VALID_BAR}}
	\subfigure[60 \% MCR]{\includegraphics[width=0.32\textwidth]{60_VALID_BAR}}
