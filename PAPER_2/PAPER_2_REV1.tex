...
\author{B.T. Rawlins $^{a}$ \corref{mycorrespondingauthor}}
...
\begin{figure}[h!]
\centerline{
	\subfigure[100\% MCR]{\includegraphics[width=0.4\textwidth]{100_VALID_BAR}}
	\subfigure[80\% MCR]{\includegraphics[width=0.4\textwidth]{80_VALID_BAR}}
	\subfigure[60\% MCR]{\includegraphics[width=0.4\textwidth]{60_VALID_BAR}}}
...
\subfigure[Case 1]{\includegraphics[width=0.32\textwidth]{BOT_TEMP}}
\subfigure[Case 2]{\includegraphics[width=0.32\textwidth]{MID_TEMP}}
\subfigure[Case 3]{\includegraphics[width=0.32\textwidth]{FBRM_TEMP}}\\
\subfigure[Case 4]{\includegraphics[width=0.32\textwidth]{BOT05_TEMP}}
\subfigure[Case 5]{\includegraphics[width=0.32\textwidth]{MID05_TEMP}}
\subfigure[Case 6]{\includegraphics[width=0.32\textwidth]{FBRM05_TEMP}}
...
\subfigure[Case 1]{\includegraphics[width=0.32\textwidth]{BOT_VEL}}
\subfigure[Case 2]{\includegraphics[width=0.32\textwidth]{MID_VEL}}
\subfigure[Case 3]{\includegraphics[width=0.32\textwidth]{FBRM_VEL}}\\
\subfigure[Case 4]{\includegraphics[width=0.32\textwidth]{BOT05_VEL}}
\subfigure[Case 5]{\includegraphics[width=0.32\textwidth]{MID05_VEL}}
\subfigure[Case 6]{\includegraphics[width=0.32\textwidth]{FBRM05_VEL}}
...
\subfigure[Case 1]{\includegraphics[scale = 0.35]{BOT_HEATFLUX}}
\hspace{5mm}
\subfigure[Case 2]{\includegraphics[scale = 0.35]{MID_HEATFLUX}}
\hspace{5mm}
\subfigure[Case 3]{\includegraphics[scale = 0.35]{FBRM_HEATFLUX}}\\
\subfigure[Case 4]{\includegraphics[scale = 0.29]{BOT05_HEATFLUX}}
\hspace{5mm}
\subfigure[Case 5]{\includegraphics[scale = 0.35]{MID05_HEATFLUX}}
\hspace{5mm}
\subfigure[Case 6]{\includegraphics[scale = 0.35]{FBRM05_HEATFLUX}}
...
\subfigure[Case 1]{	\includegraphics[width=0.18\textwidth, height = 7cm]{BOT_ISO_COPPM_F}
				\includegraphics[height = 7cm]{BOT_ISO_COPPM_S}}
\subfigure[Case 2]{	\includegraphics[width=0.18\textwidth, height = 7cm]{MID_ISO_COPPM_F}
				\includegraphics[height = 7cm]{MID_ISO_COPPM_S}}
\subfigure[Case 3]{	\includegraphics[width=0.18\textwidth, height = 7cm]{FBRM_ISO_COPPM_F}
				\includegraphics[height = 7cm]{FBRM_ISO_COPPM_S}}\\
\subfigure[Case 4]{	\includegraphics[width=0.18\textwidth, height = 7cm]{BOT05_ISO_COPPM_F}
				\includegraphics[height = 7cm]{BOT05_ISO_COPPM_S}}
\subfigure[Case 5]{	\includegraphics[width=0.18\textwidth, height = 7cm]{MID05_ISO_COPPM_F}
				\includegraphics[height = 7cm]{MID05_ISO_COPPM_S}}
\subfigure[Case 6]{	\includegraphics[width=0.18\textwidth, height = 7cm]{FBRM05_ISO_COPPM_F}
...
\begin{figure}[h!]
\centering
\subfigure[Symmetry vertical plot]{\includegraphics[scale = 0.36]{SYMMETRY_PROBE_COPPM}}
\hspace{5mm}
\subfigure[Offset vertical plot]{\includegraphics[scale = 0.36]{OFFSET_PROBE_COPPM}}\\
\subfigure[Symmetry vertical plot]{\includegraphics[scale = 0.35]{SYMMETRY_PROBE_XO2}}
\hspace{5mm}
\subfigure[Offset vertical plot]{\includegraphics[scale = 0.35]{OFFSET_PROBE_XO2}}
