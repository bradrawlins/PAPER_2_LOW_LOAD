...
\entry{$f_{heat}$}{Surface char oxidation fraction [-]}
...
\entry{$t$}{Time [$s$]}
\entry{$U_i$}{Overall heat transfer coefficient}
\entry{}{[$W/m^2K$]}
...
\entry{$\sigma_{SB}$}{Stefan-Boltzmann constant}
\entry{}{[$W/m^2K^4$]}
...
\vspace{2mm}     
\begin{tabularx}{0.8\textwidth}{p{0.1\textwidth} p{0.4\textwidth} l}
\hline
...
\vspace{2mm}
\label{tbl_fuel}
\begin{tabularx}{0.7\textwidth}{p{0.3\textwidth} p{0.2\textwidth} l}
\hline
...
\vspace{2mm}
{\tabulinesep=1.2mm
\begin{tabularx}{0.7\textwidth}{p{0.27\textwidth} p{0.225\textwidth} l}
\hline
...
\begin{figure*}[h!]
\centering
\subfigure[]{\includegraphics[width = 0.475\textwidth, height =5cm ]{COPPM_VALID}}
\hspace{5mm}
\subfigure[]{\includegraphics[width = 0.475\textwidth, height =5cm ]{XO2_VALID}}
...
\vspace{2mm}
\begin{tabularx}{\textwidth}{p{0.35\textwidth} XXXXXX}
\hline
...
\vspace{2mm}
{\tabulinesep=1.2mm
\begin{tabularx}{0.6\textwidth}{p{0.25\textwidth} XX}
\hline
