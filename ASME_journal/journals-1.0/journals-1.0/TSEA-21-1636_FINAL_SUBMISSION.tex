...
\vspace{2mm}     
\begin{tabularx}{0.6\textwidth}{p{0.4in} p{0.3\textwidth} l}
\hline
...
\hl{The boiler furnace is fed by six mills, each supplying a pulverised fuel and primary air (PA) mixture to a burner row consisting of six opposing wall mounted swirl burners. The swirl vanes were not modelled in this study, rather an axial and tangential velocity component were used for the secondary air (SA) inlets with these values being obtained from a detailed burner model supplied by the burner manufacturer, which included the vanes. The fuel/PA mixture is injected through the inner annulus of the burner while the SA air is fed through the outer annulus as seen in Fig. 2.}\\ 
...
\end{equation}
\hl{The overall heat transfer coefficient (U) is subsequently determined using the following expression.}
\begin{equation}\label{eqn_overall_heat_coeff}
U_i=\frac{1}{\frac{1}{h_{int}}+\frac{t_{wall}}{\lambda_{wall}}+\frac{t_{ash}}{\lambda_{ash}}}
\end{equation}

\hl{A 1D process model was used to estimate the furnace, platen and final SH internal heat transfer coefficients and internal temperatures for the low load case. For the validation cases the experimental data from site was used to estimate the mean water temperature in the heat exchangers.}\\
...
\begin{figure}[h!]
\centering
\subfigure[]{\includegraphics[width = 3.25in, height =5cm ]{COPPM_VALID}}
\hspace{5mm}
\subfigure[]{\includegraphics[width = 3.25in, height =5cm ]{XO2_VALID}}
...
\subfigure[Case 1]{\includegraphics[width=0.25\textwidth]{BOT_TEMP}}
\subfigure[Case 2]{\includegraphics[width=0.25\textwidth]{MID_TEMP}}
\subfigure[Case 3]{\includegraphics[width=0.25\textwidth]{FBRM_TEMP}}\\
\subfigure[Case 4]{\includegraphics[width=0.25\textwidth]{BOT05_TEMP}}
\subfigure[Case 5]{\includegraphics[width=0.25\textwidth]{MID05_TEMP}}
\subfigure[Case 6]{\includegraphics[width=0.25\textwidth]{FBRM05_TEMP}}
...
\subfigure[Case 1]{\includegraphics[width=0.25\textwidth]{BOT_VEL}}
\subfigure[Case 2]{\includegraphics[width=0.25\textwidth]{MID_VEL}}
\subfigure[Case 3]{\includegraphics[width=0.25\textwidth]{FBRM_VEL}}\\
\subfigure[Case 4]{\includegraphics[width=0.25\textwidth]{BOT05_VEL}}
\subfigure[Case 5]{\includegraphics[width=0.25\textwidth]{MID05_VEL}}
\subfigure[Case 6]{\includegraphics[width=0.25\textwidth]{FBRM05_VEL}}
...
\subfigure[Case 1]{\includegraphics[width=0.18\textwidth]{BOT_HEATFLUX}}
\hspace{10mm}
\subfigure[Case 2]{\includegraphics[width=0.2\textwidth]{MID_HEATFLUX}}
\hspace{10mm}
\subfigure[Case 3]{\includegraphics[width=0.2\textwidth]{FBRM_HEATFLUX}}\\
\subfigure[Case 4]{\includegraphics[width=0.18\textwidth]{BOT05_HEATFLUX}}
\hspace{10mm}
\subfigure[Case 5]{\includegraphics[width=0.2\textwidth]{MID05_HEATFLUX}}
\hspace{10mm}
\subfigure[Case 6]{\includegraphics[width=0.2\textwidth]{FBRM05_HEATFLUX}}
...
\subfigure[Case 1]{	\includegraphics[width=0.16\textwidth, height = 7cm]{BOT_ISO_COPPM_F}
				\includegraphics[height = 7cm]{BOT_ISO_COPPM_S}}
\hspace{5mm}
\subfigure[Case 2]{	\includegraphics[width=0.16\textwidth, height = 7cm]{MID_ISO_COPPM_F}
				\includegraphics[height = 7cm]{MID_ISO_COPPM_S}}
\hspace{5mm}
\subfigure[Case 3]{	\includegraphics[width=0.16\textwidth, height = 7cm]{FBRM_ISO_COPPM_F}
				\includegraphics[height = 7cm]{FBRM_ISO_COPPM_S}}\\
\subfigure[Case 4]{	\includegraphics[width=0.16\textwidth, height = 7cm]{BOT05_ISO_COPPM_F}
				\includegraphics[height = 7cm]{BOT05_ISO_COPPM_S}}
\hspace{5mm}
\subfigure[Case 5]{	\includegraphics[width=0.16\textwidth, height = 7cm]{MID05_ISO_COPPM_F}
				\includegraphics[height = 7cm]{MID05_ISO_COPPM_S}}
\hspace{5mm}
\subfigure[Case 6]{	\includegraphics[width=0.16\textwidth, height = 7cm]{FBRM05_ISO_COPPM_F}
...
\begin{figure*}[h!]
\centering
\subfigure[Symmetry vertical plot]{\includegraphics[scale = 0.45]{SYMMETRY_PROBE_COPPM}}
\hspace{5mm}
\subfigure[Offset vertical plot]{\includegraphics[scale = 0.45]{OFFSET_PROBE_COPPM}}
\hspace{5mm}
\subfigure[Symmetry vertical plot]{\includegraphics[scale = 0.45]{SYMMETRY_PROBE_XO2}}
\hspace{5mm}
\subfigure[Offset vertical plot]{\includegraphics[scale = 0.45]{OFFSET_PROBE_XO2}}
